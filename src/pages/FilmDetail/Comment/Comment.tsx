...
const Comment = (props: Props) => {
    ...
    const renderListComment = () => {
        ...
        for (let i = 0; i < noOfElement; i++) {
            ...
            let arrData = (
                <div className="comment" key={i} ref={myRef}>
                    <div className="comment__header">
                        <img
                            className="avatar__user"
                            src={listData.avatar[Math.floor(Math.random() * listData.avatar.length)]}
                        />
                        <div className="comment__info">
                            <span className="username__user">
                                {listData.name[Math.floor(Math.random() * listData.name.length)]}
                            </span>
                            <br />
                    ...
                    <p className="comment__user">
                        {listData.comment[Math.floor(Math.random() * listData.comment.length)]}
                    </p>
                    <span className="rate">
                        <p className="ratePoint">{rateVote}</p>
                        <div className="star">{renderStar(rateVote)}</div>
                    </span>
