...
// thunk actions
export const getMovieShowing = createAsyncThunk("movie/getMovieShowing", async (currentPage: number) => {
    try {
...
export const getMovieDetail = createAsyncThunk("movie/getMovieDetail", async (maPhim: string) => {
    try {
