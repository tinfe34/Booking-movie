...
const ListCinemas = () => {
    ...
    const renderListCinema = () => {
        return SysCinemas?.map((sysCinema, index) => {
            return (
                <TabPane tab={<img src={sysCinema.logo} width={50} height={50} />} key={index}>
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        {phim.lstLichChieuTheoPhim.map((ds, indexssss) => {
                                                            if (indexssss < 6) {
                                                                let maRap = sysCinema.maHeThongRap.toLowerCase();
                                                                if (localStorage.getItem(USERLOGIN)) {
                                                                    return (
                                                                        <Menu.Item key={createRandomNumber(120000, 90)}>
                                                                            <a
                                                                                target="_blank"
                                                                                // onClick={() => {
                                                                                //     dispatch({
                    ...
                    <Panel
                        header={
                            <div className="titleCinemaMobile">
                                ...
                                <div className="nameCinemasMobile">{sysCinema.maHeThongRap}</div>
                            </div>
                        }
                        key={index}
                    >
                                    ...
                                    <Panel
                                        header={
                                            <div className="titleCinemasChildMobile">
                                                <img className="logoCinemasChildMobile" src={sysCinema.logo} />
                                                <div className="infoCinemasChildMobile">
                                                    <div className="nameCinemasChildMobile">{cinema.tenCumRap}</div>
                                                    <div className="addCinemasChildMobile">{cinema.diaChi}</div>
                                                </div>
                                            </div>
                                        }
                                        key={inde}
                                                ...
                                                <Collapse expandIconPosition="end" key={ind}>
                                                    <Panel
                                                        header={
                                                            <div className="infoFilmCinemaMobile">
                                                                <img className="imgFilmMobile" src={movie.hinhAnh} />
                                                    ...
                                                    >
                                                        ...
                                                        <div key={ind + 300} className="row ml-2">
                                                            {movie.lstLichChieuTheoPhim.map((ds, indexssss) => {
                                                                if (indexssss <= 6) {
                                                                    let maRap = sysCinema.maHeThongRap.toLowerCase();
                                                                    if (localStorage.getItem(USERLOGIN)) {
                                                                        return (
